...
|-----------------------------|-----------------------|----------------|--------------------|
| is_mention                  | tanersezerr@gmail.com | Yes            | Mention            |
| is_hashtag                  | #ts-tokenizer         | Yes            | Hashtag            |
| is_in_quotes                | "ts-tokenizer"        | No             | -----              |
| is_numbered_title           | (1)                   | Yes            | Numbered_Title     |
| is_in_paranthesis           | (bilgisayar)          | No             | -----              |
| is_date_range               | 01.01.2024-01.01.2025 | Yes            | Date_Range         |
| is_complex_punc             | -yeniden,sonradan..   | No             | -----              |
| is_date                     | 22.02.2016            | Yes            | Date               |
| is_hour                     | 14.05                 | Yes            | Hour               |
| is_percentage_numbers       | %75                   | Yes            | Percentage_Numbers |
| is_percentage_numbers_chars | %75'lik               | Yes            | Percentage_Numbers |
| is_roman_number             | XI                    | Yes            | Roman_Number       |
| is_bullet_list              | •Giriş                | Yes            | BUllet_List        |
