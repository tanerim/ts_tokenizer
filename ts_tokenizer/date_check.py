...
class DateValidator:
    ...
    @classmethod
    def is_valid_date_yyyy_mm_dd(cls, date_str: str) -> bool:
        match = re.match(r"^(\d{4})([-/.:])(0?[1-9]|1[0-2])\2(0?[1-9]|[1-2][0-9]|3[0-1])$", date_str)
        if not match:
            return False
...
class DateCheck:
    ...
    def is_date(date_str: str) -> bool:
        ...
        return (
                DateValidator.is_valid_date_yyyy_mm_dd(date_str.strip()) or
